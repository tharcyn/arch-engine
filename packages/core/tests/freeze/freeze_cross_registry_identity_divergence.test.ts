...
describe('Freeze Evidence: Cross Registry Identity Divergence', () => {
    test('Same overlay id, same version, different registry source forces closure identity divergence', () => {
